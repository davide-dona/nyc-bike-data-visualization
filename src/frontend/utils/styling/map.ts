// Diverging editorial ramp for station usage, anchored at mean: rust (far below) → paper rail (at mean) → accent ink (far above); neutral sits at index 3 (center of 7) so deck.gl maps value=0 to grey.
