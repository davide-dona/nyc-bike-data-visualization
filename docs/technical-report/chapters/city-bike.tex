...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{../media/rides_time.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\textwidth]{../media/rides_stations.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{../media/rides_type.png}
...
In 2020, Citi Bike updated its trip data schema, introducing column and formatting changes that differ from the 2013–2019 legacy format (detailed in our \href{https://github.com/davide-dona/nyc-bike-data-visualization/blob/main/src/notebooks/analysis.ipynb}{analysis notebook}).
