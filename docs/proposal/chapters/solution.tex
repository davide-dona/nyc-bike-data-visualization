...
\begin{itemize}
  ...
  \item \textbf{Weather and environmental context}: Incorporating weather data will allow us to analyze how environmental conditions affect bike usage patterns, using ridge plots such as the one sketched in Figure~\ref{fig:mockup-ridge-graph}.
