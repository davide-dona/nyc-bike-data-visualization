...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.7\textwidth]{media/heatmap.jpeg}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.7\textwidth]{media/trip-layer.jpeg}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\textwidth]{media/surface-graph.jpeg}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.7\textwidth]{media/ridge-graph.jpeg}
