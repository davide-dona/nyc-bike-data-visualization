...
Each source is parsed to extract only the required fields, and any records with missing station, timestamp, user, or bike type data are dropped rather than generated.
